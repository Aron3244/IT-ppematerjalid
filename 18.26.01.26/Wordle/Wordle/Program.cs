...
try
{
    // === CHANGE: Load words from Desktop instead of embedded resource ===
    string filePath = @"C:\Users\opilane\Desktop\FiveLetterWords.txt";
    if (!File.Exists(filePath))
    {
        Console.WriteLine($"Error: Missing file at {filePath}");
